                ...
                c => new
                    {
                        ...
                        介護支援専門員在席人数 = c.Double(nullable: false),
                        介護支援専門員常勤換算 = c.Double(nullable: false),
                        事務員在席人数 = c.Double(nullable: false),
                        事務員常勤換算 = c.Double(nullable: false),
                        その他在席人数 = c.Double(nullable: false),
                        その他常勤換算 = c.Double(nullable: false),
                        全職員在席人数 = c.Double(nullable: false),
                        全職員常勤換算 = c.Double(nullable: false),
                        経験5年以上割合 = c.Double(nullable: false),
                        要介護5 = c.Double(nullable: false),
                        要介護4 = c.Double(nullable: false),
                        要介護3 = c.Double(nullable: false),
                        要介護2 = c.Double(nullable: false),
                        要介護1 = c.Double(nullable: false),
                        要支援2 = c.Double(nullable: false),
                        要支援1 = c.Double(nullable: false),
                        自立 = c.Double(nullable: false),
                        利用者の権利擁護 = c.Double(nullable: false),
                        サービスの質の確保 = c.Double(nullable: false),
                        相談苦情等への対応 = c.Double(nullable: false),
                        外部機関等との連携 = c.Double(nullable: false),
                        事業運営管理 = c.Double(nullable: false),
                        安全衛生管理等 = c.Double(nullable: false),
                        従業者の研修等 = c.Double(nullable: false),
                        Email = c.String(),
